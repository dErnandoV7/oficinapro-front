      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <DialogTitle>{ativar ? "Ativar cliente?" : "Desativar cliente?"}</DialogTitle>
          </div>
          <DialogDescription className="pt-2">
            Tem certeza que deseja {ativar ? "ativar" : "desativar"} <strong>{nomeCliente}</strong>?
            {!ativar && " Não será possível abrir novas comandas para um cliente inativo."}
          </DialogDescription>
        </DialogHeader>
